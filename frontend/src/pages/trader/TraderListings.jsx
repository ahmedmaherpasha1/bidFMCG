        ...
        <div className="overflow-x-auto">
                ...
                <tr key={l.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <button onClick={() => navigate(`/trader/listings/${l.id}`)} className="p-1.5 text-gray-400 hover:text-green-600 hover:bg-green-50 rounded-lg transition-colors">
                        <Edit size={16} />
                      </button>
          ...
          {myListings.length === 0 && (
            <div className="text-center py-16 text-gray-400">
              ...
              <Button size="sm" className="mt-3" onClick={() => navigate('/trader/listings/new')}>
